<!--<?php
$met_nav=metlabel_nav(1,'<li class="line">|</li>',710,3);
echo <<<EOT
-->
<!DOCTYPE HTML>
<html>
...
<div class="headLogo">
			<h2 class="title">
				<a href="{$index_url}" title="{$met_webname}">
					<img src="{$met_weburl}{$met_logo}" alt="{$met_webname}" title="{$met_webname}" />
				</a>
			</h2>
</div>

<div class="headNav">{$met_nav}<div class="clear"></div></div>
